...
Grâce à cette commande ,on officialise une première version de notre site, que l'on peut annoter avec l'option "-a V1.0" qui enregistre la date et l'auteur du tage ainsi que le message renseigné après "-m message"
